...
{
    // 은신처 카메라 시설 선택 라우터
    // UI가 없을 때는 Inspector 테스트용으로 사용하고, 추후 UI 버튼이나 상호작용 입력에서도 같은 메서드를 호출
    ...
    public sealed class HideoutCameraFacilitySelector : MonoBehaviour
    {
        ...
        // 외부에서 시설 enum으로 카메라 이동을 요청할 때 사용
        // 추후 UI, 상호작용, 시설 클릭 입력에서 호출
        ...
        // 외부에서 HideoutCameraTarget을 직접 넘겨 카메라 이동을 요청할 때 사용
