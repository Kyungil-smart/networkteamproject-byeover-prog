// ============================================================================
// KHWScriptObjectPoolSO.cs
// 목적: 일반/무기/탄약/헬멧/방어구 ScriptableObject를 분류 보관하고 itemID로 검색합니다.
// 패턴: ScriptableObject Database + Dictionary Cache.
// 적용: GameObject 컴포넌트가 아니라 Project 창에서 생성하는 SO 에셋입니다.
// ============================================================================
